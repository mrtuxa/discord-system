package eu.overnetwork.handler.cmd;
...
public class CommandHandler implements MessageCreateListener, SlashCommandCreateListener {
    ...
    public void onSlashCommandCreate(SlashCommandCreateEvent event) {
        ...
        if (command != null){
            System.out.println(String.format("Received slash command - '%s'", commandName.toLowerCase()));
    ...
    public void onMessageCreate(MessageCreateEvent event) {
        ...
        server.ifPresent(value -> {
            ...
            if (message.startsWith(prefix)) {
                ...
                if (command != null) {
                    System.out.println(String.format("Received guild command - '%s'", firstWord.toLowerCase()));
                    command.runCommand(event);
                }
            }
        });
