...
public class TrackScheduler implements AudioEventListener {
    ...
    public void queue(AudioTrack track){
        ...
        System.out.println(String.format("Current queue size: %d", queueSize));
    ...
    private void onTrackStart(AudioTrack track) {
        ...
        String video = String.valueOf(youtube.getVideoSnippedById(track.getIdentifier()));
    ...
    private void onTrackEnd(AudioTrack track, AudioTrackEndReason endReason) {
        ...
        System.out.println(String.format("Is Playing Track Null: %b", isPlayingTrackNull));
